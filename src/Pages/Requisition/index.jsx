            ...
            <form id="form" onSubmit={handleSubmit} className="mt-6">
              <div className="mb-2">
                ...
                <div className="grid grid-cols-2">
                  <div>
                    <p className="text-red-600 text-xs">{DataErr.fname}</p>
                  </div>
                  <div>
                    <p className="text-red-600 text-xs">{DataErr.lname}</p>
                  </div>
                </div>
              </div>
              <div className="mb-2">
                ...
                <p className="text-red-600 text-xs">{DataErr.address}</p>
              </div>
              <div className="grid grid-cols-2 gap-1">
                <div className="mb-2">
                  ...
                  <p className="text-red-600 text-xs">{DataErr.region}</p>
                </div>
                <div className="mb-2">
                  <label className="block text-sm font-medium text-gray-700 tracking-wide">
                    Postal Code
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <p className="text-red-600 text-xs">{DataErr.postal}</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-1">
                <div className="mb-2">
                ...
                <div className="mb-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <p className="text-red-600 text-xs">{DataErr.location}</p>
                </div>
              </div>
              <div className="mb-2">
                <label className="block text-sm font-medium text-gray-700 tracking-wide">
                ...
                <input
                  ...
                  onChange={handleChange}
                />
                <p className="text-red-600 text-xs">{DataErr.profession}</p>
              </div>
              <div className="w-full flex items-center">
                  ...
                  <div className="flex justify-start gap-1 my-2">
                    <div className="w-full">
                      <input
                        ...
                        onChange={handleChange}
                      />
                      <p className="text-red-600 text-xs">{DataErr.phone}</p>
                    </div>
                  </div>
                </div>
                <div className="w-full mb-2 ml-2">
                  ...
                  onChange={handleChange}
                /> */}
                  <p className="text-red-600 text-xs">{DataErr.birth}</p>
                </div>
              </div>
              ...
              <div className="mb-2">
                ...
                <p className="text-red-600 text-xs">{DataErr.Cname}</p>
              </div>
              <div className="mb-2">
                <label>
                  <span className="block text-sm font-medium text-gray-700 tracking-wide">
              ...
              <div className="mb-2">
                ...
                <p className="text-red-600 text-xs">{DataErr.logo}</p>
              </div>
              ...
              <div className="mb-2">
                ...
                <input
                  ...
                  onChange={handleChange}
                />
                <p className="text-red-600 text-xs">{DataErr.telNo}</p>
              </div>
              <div className="mb-2">
                <label>
                  <span className="block text-sm font-medium text-gray-700 tracking-wide">
                ...
                <p className="text-red-600 text-xs">{DataErr.email}</p>
              </div>
              <div className="mb-2">
                <label>
                  <span className="block text-sm font-medium text-gray-700 tracking-wide">
                ...
                <p className="text-red-600 text-xs">{DataErr.Caddress}</p>
              </div>
              <div className="grid grid-cols-3 gap-1">
                <div className="mb-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <p className="text-red-600 text-xs">{DataErr.Tname}</p>
                </div>
                <div className="mb-2">
                  <label className="block text-sm font-medium text-gray-700 tracking-wide">
                    RTO code
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <p className="text-red-600 text-xs">{DataErr.rto}</p>
                </div>
                <div className="mb-2">
                  <label className="block text-sm font-medium text-gray-700 tracking-wide">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <p className="text-red-600 text-xs">{DataErr.abn}</p>
                </div>
              </div>
              <div className="mb-2">
                <label>
                ...
                <p className="text-red-600 text-xs">{DataErr.Cweb}</p>
              </div>
              <div className="mb-2">
                <label className="block text-sm font-medium text-gray-700 tracking-wide">
                  Country
                ...
                <p className="text-red-600 text-xs">{DataErr.country}</p>
              </div>
              <div className="mb-2">
                <label>
                  <span className="block text-sm font-medium text-gray-700 tracking-wide">
